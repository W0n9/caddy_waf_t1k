...
func TestIsEngineError(t *testing.T) {
	tests := []struct {
		...
		{"engine-side connection reset is engine error", errors.New("read tcp 222.199.255.27:56702->10.2.137.29:8000: read: connection reset by peer"), true},
		{"engine-side write connection reset is engine error", errors.New("write tcp 222.199.255.27:32552->10.2.137.29:8000: write: connection reset by peer"), true},
